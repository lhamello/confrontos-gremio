...
public class ContinenteTest {
  ...
  @Test
  public void testNumeroContinentes() {
  ...
  public void testAbreviatura(final String abreviaturaEsperada, final Continente continenteAtual) {
  ...
  public void testNome(final String nomeEsperado, final Continente continenteAtual) {
  ...
  public void testContinente(final Continente continenteEsperado, final String siglaAtual) {
  ...
  @CsvSource(value = { "África (AFR), AFRICA", "América do Norte (AMN), AMERICA_DO_NORTE", "América do Sul (AMS), AMERICA_DO_SUL", "Ásia (ASI), ASIA", "Europa (EUR), EUROPA",
      "Oceania (OCE), OCEANIA" })
  public void testToString(final String descricaoEsperada, final Continente continenteAtual) {
  ...
  public void testOrdinal(final int numeroEsperado, final Continente continenteAtual) {
  ...
  @NullAndEmptySource
  public void testContinenteNaoEncontrado(final String abreviatura) {
